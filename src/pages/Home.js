...
//   const isOwner = (b) =>
//     String(typeof b.userId === 'object' ? b.userId._id : b.userId) ===
...
//               <input name="professor" placeholder="Professor Name" onChange={handleChange} required />
...
//               <select name="startTime" onChange={handleChange} required>
...
//               <select name="endTime" onChange={handleChange} required>
